...
public class FruitfiestaIcon extends MiniGameIcon {
    public FruitfiestaIcon(int id, String TAG, Point pos, final Context context, final RelativeLayout container, int stars, final boolean enabled){
        super(id, TAG, pos, context, container, stars, enabled);

        resourceImgId =  R.drawable.fruitfiesta_icon;
        icon.setImageResource(resourceImgId);
        //imagePosChange = new Point(-50,-80);
        rescale();
